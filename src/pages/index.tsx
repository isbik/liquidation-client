      ...
      <section className="about_us">
        <div className="container">
          ...
          <div className="about_us-right">
            <img src="img/about_us-img.jpg" alt="" />
          </div>
        </div>
      </section>
          ...
          <div className="accordion_item">
            ...
            <div className="accordion_content">
              <p>
                ...
                покупателей, включая новые, бывшие в употреблении товары, снятые
                с полки, восстановленные, возвратные и утилизированные во многих
                различных категориях.
              </p>
              <p>
                Наши категории продуктов включают одежду и аксессуары, ювелирные
                изделия и часы, компьютеры и сети, бытовую электронику, товары
                общего назначения, товары для дома, инструменты и оборудование,
                а также приспособления и приспособления для магазинов.
              </p>
            </div>
          </div>
          <div className="accordion_item">
